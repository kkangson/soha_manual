...
interface BadgeProps {
    ...
    variant?: 'default' | 'spicy' | 'vegetarian' | 'info' | 'outline';
    className?: string;
}
...
export const Badge: React.FC<BadgeProps> = ({
    ...
    const variants = {
        ...
        info: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 border border-blue-200 dark:border-blue-900',
